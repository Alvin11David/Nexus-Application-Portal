...
const stories: Story[] = [
  ...
  },
  {
    ...
    before: "Unemployed for two years after completing secondary school, no capital to start a business.",
    after: "Owns a salon with five stations, employs three stylists, trains new graduates.",
    fullStory: "Esther completed secondary school but couldn't afford university. Two years of unemployment followed, during which she grew increasingly discouraged. A friend who had graduated from Veritas convinced her to try the hairdressing program. Esther discovered a passion for hair styling and customer service. She practised on anyone willing — neighbours, fellow students, even instructors. After graduating, the institute lent her a salon chair and basic supplies. She started doing hair from her home, building a loyal customer base through word of mouth. Within 18 months she had saved enough to rent a proper space. Today, Esther's salon has five styling stations and employs three other graduates from the program.",
  },
  {
  ...
  },
  {
    ...
    before: "Dropped out of school at 16, no prospects, living in poverty with her widowed mother.",
    after: "Works at a beauty spa in Kampala, sends money home monthly, saving to open her own business.",
      ...
      if (storiesRef.current) {
        gsap.fromTo(storiesRef.current.querySelectorAll(".story-card"),
          ...
          { y: 0, opacity: 1, duration: 0.8, stagger: 0.15, ease: "power3.out",
            scrollTrigger: { trigger: storiesRef.current, start: "top 80%", toggleActions: "play none none reverse" } }
        );
      }
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="relative min-h-[55vh] flex items-end overflow-hidden">
        <img src={storiesHero} alt="Graduate success" className="absolute inset-0 w-full h-full object-cover rounded-none" />
        ...
        <div className="relative z-10 px-8 md:px-16 pb-20 pt-40 stories-hero-text max-w-4xl">
          <p className="font-body text-xs tracking-[0.3em] uppercase text-accent mb-5 opacity-0">Student Stories</p>
          <h1 className="font-heading text-5xl md:text-7xl font-light text-primary-foreground leading-[0.92] mb-6 opacity-0">
            Real People.<br /><em className="text-accent">Real Transformation.</em>
          </h1>
          <p className="font-body text-base text-primary-foreground/70 max-w-xl leading-relaxed opacity-0">
            Behind every statistic is a person whose life was changed by practical skills and the belief that a better future is possible.
          </p>
        </div>
      </div>
      ...
      <section className="py-24 md:py-32 px-8 md:px-16">
        <div className="max-w-2xl mb-16">
          <p className="font-body text-xs tracking-[0.3em] uppercase text-accent mb-4">Their Journeys</p>
          <h2 className="section-heading font-heading text-4xl md:text-6xl font-light text-foreground leading-tight">
            From Hardship<br />To Hope
          </h2>
        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-[320px_1fr] lg:grid-cols-[380px_1fr]">
                ...
                <div className="p-8 md:p-10 flex flex-col">
                  <div className="flex items-start gap-3 mb-4">
                    <div>
                      <h3 className="font-heading text-2xl md:text-3xl font-light text-foreground">{story.name}</h3>
                      <p className="font-body text-xs text-muted-foreground mt-1">
                        {story.program} · Graduated {story.graduated} · Age {story.age}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                    <div className="p-4 bg-destructive/5 border border-destructive/10 rounded-xl">
                      <p className="font-body text-[10px] tracking-[0.2em] uppercase text-destructive/60 mb-2">Before</p>
                      <p className="font-body text-sm text-foreground/70 leading-relaxed">{story.before}</p>
                    </div>
                    <div className="p-4 bg-accent/5 border border-accent/10 rounded-xl">
                      <p className="font-body text-[10px] tracking-[0.2em] uppercase text-accent/80 mb-2">After</p>
                      <p className="font-body text-sm text-foreground/70 leading-relaxed">{story.after}</p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <ChevronDown size={14} className={`transition-transform duration-300 ${expandedStory === i ? "rotate-180" : ""}`} />
                  </button>

                  {expandedStory === i && (
                    <div className="mt-6 pt-6 border-t border-border">
                      <p className="font-body text-sm text-muted-foreground leading-relaxed">{story.fullStory}</p>
                    </div>
                  )}
                </div>
              </div>
      ...
      <section className="py-24 md:py-32 px-8 md:px-16 bg-primary text-primary-foreground">
        <div className="max-w-3xl mx-auto text-center">
          <p className="font-body text-xs tracking-[0.3em] uppercase text-accent mb-6">Be Part of the Story</p>
          <h2 className="font-heading text-4xl md:text-6xl font-light text-primary-foreground leading-tight mb-8">
            Help Write the Next<br />Success Story
          </h2>
          <p className="font-body text-sm text-primary-foreground/60 leading-relaxed mb-10 max-w-lg mx-auto">
            Every student who walks through our doors has the potential to transform their life and their community. Your support makes it possible.
          </p>
