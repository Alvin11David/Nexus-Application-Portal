  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="relative min-h-[60vh] flex items-end">
        ...
        <div
          ref={heroRef}
          className="relative z-10 px-8 md:px-16 pb-24 pt-40 programs-hero-text max-w-4xl"
        >
      ...
      <div className="px-8 md:px-16 py-24 bg-primary text-primary-foreground text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <button
            ...
            className="group flex items-center gap-2 px-10 py-4 border border-primary-foreground/30 text-primary-foreground font-body text-sm tracking-[0.2em] uppercase rounded-[20px] transition-all duration-500 hover:border-accent hover:text-accent"
          >
            Contact Us
            <ArrowRight
              size={16}
