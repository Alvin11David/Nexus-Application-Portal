...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        ref={navRef}
        className={`fixed top-0 left-0 right-0 transition-all duration-700 opacity-0 ${mobileOpen ? "z-[70]" : "z-50"} ${
          scrolled || mobileOpen
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed inset-0 z-[60] bg-background flex flex-col items-center justify-center gap-6 transition-all duration-500 md:hidden ${
          mobileOpen
